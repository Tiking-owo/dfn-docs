# Copilot Instructions for dfn-docs

## Project Overview
This is a VitePress-based multilingual documentation site for "豆腐脑工坊" (Tofu Brain Workshop) products, focusing on fans and batteries. The site supports Chinese (zh-CN, zh-TW), English (en), and Japanese (ja) locales.
...
- **Local Development**: `npm run docs:dev` (runs on http://localhost:5173, accessible via tiking.top)
...
- Maintain consistent URL structures for cross-language linking</content>
<parameter name="filePath">d:\GitHub\dfn-docs\.github\copilot-instructions.md